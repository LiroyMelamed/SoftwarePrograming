...
int main() {
	...
	try{
		...
		notebook.print(/*page=*/100, /*row=*/100, /*column=*/50, Direction::Horizontal, "abcd");
		...
		notebook.print(/*page=*/100, /*row=*/99, /*column=*/52, Direction::Vertical, "xyz");
			// throws error because writing the letter y will intersect with the letter c
		notebook.delete(/*page=*/100, /*row=*/99, /*column=*/51, Direction::Vertical, /*length=*/3);
			// writes ~ instead of _ in line 99, b in line 100 and _ again in line 99

		notebook.print(100); // shows the notebook's page in a reasonable way. For example:
			//    98:  _________
			//    99:  ___~_____
			//    100: __a~cd___
			//    101: ___~_____
